...
export interface InternalUIConfig extends SmUIConfig {
  // ...
}

export class SmUIManager extends UIManager {
  // constructor(player: PlayerAPI, ui: UIContainer, uiconfig?: SmUIConfig);
  // constructor(player: PlayerAPI, uiVariants: UIVariant[], uiconfig?: SmUIConfig);

  constructor(player: PlayerAPI, playerUiOrUiVariants: UIContainer | UIVariant[], uiconfig: SmUIConfig = {}) {
    super(player, playerUiOrUiVariants, uiconfig);
  }
}
